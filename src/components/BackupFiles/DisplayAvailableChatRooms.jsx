...
import ListHeaderAndButton from '../components/common/ListHeaderAndButton';
...
//next create an autocomplete with chips that gets the friends.
// start refactoring this file as well, it is a mess haha.
        ...
        <React.Fragment>
          ...
          >
            ...
            <Divider />
                <List>
                  <ListItem>
                    <Link href="/display/workbook" to="/display/workbook">
                      <ListItemText>Workbook</ListItemText>
                    </Link>
                    <ListItemSecondaryAction>
                      <Link href="/display/newWorkout" to="/display/newWorkout">
                        <Fab>
